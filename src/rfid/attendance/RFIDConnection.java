...
public class RFIDConnection {
       ...
       public interface RFIDScanListener {
            void onRFIDScanned(String rfidId);
        }
       private static RFIDScanListener scanListener;
       public static void setRFIDScanListener(RFIDScanListener listener) {
    ...
    public static void main(String[] args) {
        ...
        firstAvailableComPort = allAvailableComPorts[1];
        ...
        while (true) {
            ...
            if (bytesRead > 0) {
                ...
                if (scanListener != null) {
                    scanListener.onRFIDScanned(message);
                }
                message="";
